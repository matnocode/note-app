    ...
    folders: [
      {
        ...
        folders: [
          { name: "nextCurrentPlan" },
          {
            ...
            folders: [{ name: "nextCurrentPlan111" }],
          },
        ],
      },
      { name: "currentPlan2", folders: [{ name: "nextCurrentPlan2" }] },
    ],
    files: [
      {
        name: "txtFile.txt",
        content:
          "this is a very long content wow how could i write this on prompt damn i must be good at eberyrtihng,this is a very long content wow how could i write this on prompt damn i must be good at eberyrtihng,this is a very long content wow how could i write this on prompt damn i must be good at eberyrtihng",
      },
      {
        name: "txtFile1.txt",
        content:
